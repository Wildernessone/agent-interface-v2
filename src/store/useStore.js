        ...
        set(state => ({
          settings: {
            ...
            tools: {
              ...
              stability:  { ...state.settings.tools.stability,  key: k?.stability_key   || '' },
              tavily:     { ...state.settings.tools.tavily,     key: k?.tavily_key      || '' },
              brave:      { ...state.settings.tools.brave,      key: k?.brave_key       || '' },
              playht:     { ...state.settings.tools.playht,     key: k?.playht_key      || '' },
              udio:       { ...state.settings.tools.udio,       key: k?.udio_key        || '' },
            },
          },
          settingsLoaded: true,
        }))
