...
values (
  ...
  $n$Weekly refresh 2026-09-13, run by hand against primary sources. Scope: 16 of 29 live entries checked (14 fully and restated here; a2a and atlas only partially, so not restated); 13 not checked this week keep their 2026-08-26/27 dates. MOVED: webmcp (WebKit standards-positions #670 closed with position: oppose, comment 2026-06-03 and 2026-06-17; Mozilla #1412 labeled position: neutral and closed 2026-08-05; Draft CG Report now dated 10 September 2026; implementation-status.md lists ChatGPT Desktop (2026-08-26) and Brave Leo; README headless scope PR #296 merged 2026-09-04; chromestatus.com/feature/5117755740913664 still OT 149-156 with TAG/security/privacy Pending; Edge trial expiration November 17, 2026 confirmed), x402 (x402.org/members: 52 organizations = 17 Premier + 24 General + 11 Associate; homepage counter 75.41M tx / $24.24M 30-day), agents-md (agents.md: "used by over 60k open-source projects", "now stewarded by the Agentic AI Foundation under the Linux Foundation"; repo pushed 2026-09-10), openai-apps (developers.openai.com/apps-sdk 301 -> /plugins; developers.openai.com/llms.txt still titles the set "ChatGPT plugins and Apps SDK"), zed-acp (agentclientprotocol.com/community/governance: "ACP has two lead maintainers: Ben Brandt (Zed Industries) and Sergey Ignatov (JetBrains)", governance.mdx commit 2026-02-19; registry 42 agent dirs; no release after 2026-08-20), mcp (registry figure dated, count not re-counted; current revision 2026-07-28 and deprecated registry re-confirmed; no tag after 2026-07-28), ag-ui (docs.ag-ui.com/concepts/events: 34 event types incl. 1 draft + 2 deprecated; README names no foundation; release 2026-09-11). UNCHANGED: agent-plugins (PR #37 open, MAINTAINERS.md five names, last commit 2026-08-19), agent-builder (developers.openai.com/api/docs/deprecations: Agent Builder and Evals shut down 2026-11-30, evals read-only 2026-10-31), computer-use (platform.claude.com: computer_toolset_20260801 on Claude API and Google Cloud; learn.chatgpt.com: ChatGPT Work and Codex on macOS and Windows, Locked use plug-in; ai.google.dev: browser/mobile/desktop, updated 2026-09-04), agent-protocol (repo last commit 2025-04-08; agentprotocol.ai is an independent guide), ibm-acp (archived 2025-08-27), operator (operator.chatgpt.com 308 -> chatgpt.com/?system_hints=agent), ap2 (v0.2.0 2026-04-28; FIDO 2026-04-28 post names Mastercard and Visa chairs). NOT re-verified: a2a stage/board claims (aaif.io renders them client-side; v1.0.1 2026-05-28 still newest, v1.1 milestone due 2026-10-22 confirmed), atlas post-8/9 shutdown (openai.com and help.openai.com 403 automated fetch). Full report: docs/tracker-runs/2026-09-13-weekly-refresh.md in the repo.$n$
);
